...
Gem::Specification.new do |spec|
  ...
  spec.summary = 'Unit conversion for length, weight, temperature, volume, speed, pressure, energy, and data measurements'
  spec.description = 'Unit conversion library supporting length, weight, temperature, volume, speed, pressure, ' \
                     'energy, and data categories with a simple convert API, string parsing, ' \
                     'byte humanization, unit abbreviations, and formatted output.'
